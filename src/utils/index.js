 ...
 */
export const $ = (selectors, baseElement = document) => {
 ...
 */
export const h = (tagName, propMap = {}, text) => {
 ...
 * @returns {void}
 */
export const bindEvents = (events, handler, elements = $('body')) => {
 ...
 * @returns {void}
 */
export const unbindEvents = (events, handler, element = $('body')) => {
  events.split(' ').forEach(event => {
 ...
 */
export const throttle = (method, context = {}, delay = 4, ...outParams) => {
